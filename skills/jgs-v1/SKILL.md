...
Use when you are not sure which specialist fits: describe the request in plain English and the dispatcher routes it to the right FREE-tier skill, flagging anything that needs PRO.
...
>
> This pack is read-only. The operation you requested ("_[phrase detected]_") modifies the model, which requires an upgraded licence.
>
